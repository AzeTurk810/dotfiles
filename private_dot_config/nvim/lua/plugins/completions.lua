return {
    ...
    config = function()
        ...
        local snippet_dir = vim.fn.stdpath("config") .. "/snippets/C++/"
        ...
        local function ensure_includes(includes)
            ...
            for _, inc in ipairs(includes) do
                if not existing[inc] then
                    table.insert(missing, "#include <" .. inc .. ">")
                end
            end
            ...
            vim.schedule(function()
                vim.api.nvim_buf_set_lines(0, insert_pos, insert_pos, false, missing)
        ...
        for _, snip in ipairs(snippets) do
            table.insert(
                ...
                s(snip.trigger, {
                    f(function(_, _)
                        vim.schedule(function()
                            ensure_includes(snip.includes)
                        end)
                        return ""
                    end),

                    t(read_file(snippet_dir .. snip.file)),
                })
            )
        end
